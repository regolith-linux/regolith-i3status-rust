% regolith-i3status-rust(SECTION) | User Commands
%
% "December 25 2021"
...
regolith-i3status-rust - program to do something

# SYNOPSIS

**regolith-i3status-rust** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**regolith-i3status-rust** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **regolith-i3status-rust** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**regolith-i3status-rust** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    regolith-i3status-rust. See **foo.conf**(5) for further details.
...
**regolith-i3status-rust** provides some return codes, that can be used in scripts:
